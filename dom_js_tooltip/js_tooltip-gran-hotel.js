...
if (window.innerWidth < 960) {
  ...
  punto1.style.bottom = "68%";
  punto1.style.left = "55%";
  ...
  function mostrarTooltip1Touch() {
    ...
    tooltipContainerTorre.style.top = "25%";
  ...
  punto2.style.bottom = "35%";
  punto2.style.right = "30%";
  ...
  function mostrarTooltip2Touch() {
    ...
    tooltipContainerHotel.style.top = "54%";
    tooltipContainerHotel.style.right = "3%";
