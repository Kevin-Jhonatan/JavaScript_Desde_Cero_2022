...
if (window.innerWidth < 960) {
  ...
  // Add event click to icon 'X' to close container.
  var tooltipHotelCloseContainer = document.getElementById(
    "tooltip-hotel-close"
  );
  ...
  var tooltipContainerTorre3 = document.getElementById("tooltip-torre-1");

  //tooltipContainerHotel.addEven
  // Add event click to icon 'X' to close container.
  var tooltipTorreCloseContainer3 = document.getElementById(
  ...
  var tooltipContainerHotel4 = document.getElementById("tooltip-hotel-1");

  // Add event click to icon 'X' to close container.
  var tooltipHotelCloseContainer4 = document.getElementById(
  ...
  var tooltipContainerTorre5 = document.getElementById("tooltip-torre-2");

  //tooltipContainerHotel.addEven
  // Add event click to icon 'X' to close container.
  var tooltipTorreCloseContainer5 = document.getElementById(
  ...
  var tooltipContainerHotel6 = document.getElementById("tooltip-hotel-2");

  // Add event click to icon 'X' to close container.
  var tooltipHotelCloseContainer6 = document.getElementById(
